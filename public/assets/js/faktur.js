    ...
    $('#nofaktur').change(function () {
        $.get('/search-faktur/' + this.value, function (data) {
            ...
            data.forEach(element => {
                ...
                newRow.append('<td class="text-bold-500">' + element.shipping_date + '</td>');
                newRow.append('<td class="text-bold-500">' + element.shipping_status + '</td>');
                newRow.append('<td class="text-bold-500">' + element.total_pembelian + '</td>');
                newRow.append('<td class="text-bold-500">' + element.keterangan + '</td>');
                table.append(newRow);
